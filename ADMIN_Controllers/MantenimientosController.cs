...
namespace CapaPresentacionAdmin.Controllers
{
    ...
    public class MantenimientosController : Controller
    {
        ...
        {
            //< add key = "ServidorFotos" value = "C:\Users\vrej7\Downloads\electrodomesticos" />
            string mensaje = string.Empty;
            ...
            if (decimal.TryParse(oProducto.PrecioTexto, System.Globalization.NumberStyles.AllowDecimalPoint, new CultureInfo("es-GT"), out precio))
            {
        ...
        public JsonResult imagenProducto(int id)
        {
          ...
          //  var extension = Path.GetExtension(oproducto.NombreImagen);
